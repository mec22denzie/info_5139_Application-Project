...
import RequestItemScreen from "./src/screens/RequestitemScreen";
    ...
    const unsubscribe = onAuthStateChanged(auth, async (user) => {
      if (user) {
        try {
          ...
          // Retry once if doc not found yet
          if (!userDoc.exists()) {
